        ...
        <div class="card-body">
            <blockquote class="blockquote mb-0">
                ...
                if (isset($_SESSION)) {
                    ...
                    echo '<div class="alert alert-success" role="alert">' . $pokemon['number'] . '</div>';
                    //unset($_SESSION);
                } else {
                    echo '<div class="alert alert-danger" role="alert">' . $pokemon['number'] . '</div>';
                    unset($_SESSION);
                    $pokemon = [];
                }
                ...
                <div class="row g-2 align-items-center">
                    ...
                    <div class="col-10">
                        <input type="number" maxlength="3" autofocus min="0" name="inputNumber" class="form-control" id="inputNumber" placeholder="Introduzca un numero" aria-describedby="numberHelp" readonly value="' . $pokemon['number'] . '">
                    </div>
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-lg-3 mt-md-3 mt-sm-0">
                    ...
                    <button class="btn btn-primary me-md-2" name="edited" type="submit">Aceptar</button>
                </div>
            </form>';
                ?>
